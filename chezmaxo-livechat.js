...
(function () {
  ...
  var RESPONSES = [
    ...
    { keywords: ["parler à quelqu'un","speak to someone","talk to a human","real person","speak with someone","talk with someone","may i speak","can i speak","could i speak","must i speak","speak with a human","sum1","sum 1","connect me with someone","connect me with somebody","transfer me to someone","i need to talk to someone","i need someone","get me a human","need a human","need a person"],
    ...
    { keywords: ["content management system","content management systems","cms","do you do cms","can you implement a cms","can you build a cms"],
      fr: "Oui ! On peut construire avec WordPress si vous voulez un CMS traditionnel, ou vous créer un tableau de bord personnalisé et plus simple, adapté spécifiquement à votre entreprise.",
      en: "Yes! We can build with WordPress if you want a traditional CMS, or build you a custom, simpler admin dashboard tailored specifically to your business.", emotion: "agreeing" },
    ...
    { keywords: ["test","testing","just testing","is this working"],
      fr: "Test réussi ! Je suis bien là et je réponds. Comment puis-je vous aider ?",
      en: "Test successful! I'm alive and responding. What can I help you with?", emotion: "excited" },
    { keywords: ["who made you","who created you","who built you","who designed you","who made marxo","who created marxo","qui t'a créé","qui t'a fait"],
      fr: "Maxo m'a créé ! Il m'a conçu et programmé lui-même spécifiquement pour ce site — pas de grande compagnie technologique impliquée.",
      en: "Maxo built me! He designed and coded me himself specifically for this site — no big tech company involved.", emotion: "excited" },
