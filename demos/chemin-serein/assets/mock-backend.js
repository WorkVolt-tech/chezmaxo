  ...
  function buildSeed() {
    ...
    return {
      ...
      chat_keyword_responses: [
        ...
        { id: uuid(), keywords: "pas les moyens,ne peux pas payer,aide financière,financial assistance,can't afford,no money,budget serré,low budget,i need money,need more money,need money,besoin d'argent,manque d'argent,pas d'argent", response_fr: "Nous comprenons que le budget est une préoccupation réelle. Parlons-en ensemble — nous pouvons explorer les options qui respectent vos moyens, incluant des programmes d'aide financière possibles.", response_en: "We understand budget is a real concern. Let's talk it through together — we can explore options that fit your means, including possible financial assistance programs.", active: true, position: 35, created_at: daysFromNow(-300) },
